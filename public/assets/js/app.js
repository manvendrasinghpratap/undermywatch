...
$(function(){
        $('#datatable2').DataTable({
            ...
            dom: 'Bfrtip',
            buttons: [
                { extend: 'copy', className: 'btn-purple' },
                { extend: 'csv', className: 'btn-purple' },
                { extend: 'excel', className: 'btn-purple', title: 'XLS-File' },
                { extend: 'pdf', className: 'btn-purple', title: $('title').text() },
                { extend: 'print', className: 'btn-purple' }
            ]
        });
    }),
$(function(){
 ...
 $(function() {
            var formTemplate = $('#user-shields > div').clone()[0];
            $('#user-shields').remove();
            var swalConfig = {
            ...
            $("#swal-demo1").on("click", function(e) {
                e.preventDefault(), swal(swalConfig);
            })
    })
})();
