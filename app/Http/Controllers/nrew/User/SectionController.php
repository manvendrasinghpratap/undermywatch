...
class SectionController extends Controller
{
    ...
    public function section(Sections $section, Request $request){
        //echo config('app.adminlevel');
        //echo $this->user()->level; //die();
        ...
        return view('user.sections.section')->with('section', $section)->with('links', $links)->with('domains', $domains)->with('landingpages', $landingpages);
    }
