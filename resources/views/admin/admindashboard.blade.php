	...
	<section class="section-container">
		 <!-- Page content-->
                  ...
                  <div class="list-group mb-3">
                     ...
                     <div class="list-group-item">
                        <div class="d-flex align-items-center py-3">
                           ...
                           <div class="w-50 px-3 text-center">
                              <div class="d-flex align-items-center flex-wrap justify-content-center"><a href="{{ route('admin.sections.index') }}" data-toggle="tooltip" title="All Links"><em class="fa fa-link" style="color: #4d4287;font-size: 27px;"></em></a></div>
                           </div>
                        </div>
                     </div>
                  </div><!-- END List group-->
             ...
             <!-- START Multiple List group-->
						 <?php
						 //echo '<pre>'; print_r($companyData->sections); echo '</pre>';
						 ?>
						 <?php if(count($companyData->sections)>0)  {
							 foreach($companyData->sections as $section){
							 ?>
                     ...
                     <tbody>
                        <tr>
                           ...
                           <td class="wd-xs d-none d-lg-table-cell">
                              <div class="px-2"> <?php $retunData = getTotalLinksCompany($section['id'],Auth::user()->company_id); ?>
                                 <p class="m-0 text-muted" >
																	 <em class="icon-people mr-2 fa-lg" data-toggle="tooltip" title="Section Alloted to {{$retunData['sectionAlloted'] }} Users"></em> {{$retunData['sectionAlloted'] }}</p>
                              </div>
                           </td>
                           <td class="wd-xs d-none d-lg-table-cell">
                              <div class="px-2">
                                 <p class="m-0 text-muted"  data-toggle="tooltip" title="Total Links : {{$retunData['totallinksCount'] }}"><em class="icon-doc mr-2 fa-lg"></em>{{$retunData['totallinksCount'] }}</p>
                              </div>
                           </td>
													 <td class="wd-xs d-none d-lg-table-cell">
                              <div class="px-2">
                                 <p class="m-0 text-muted"  data-toggle="tooltip" title="Total Clicks : {{$retunData['totalClicks'] }}"><em class="icon-doc mr-2 fa-lg"></em>{{$retunData['totalClicks'] }}</p>
                              </div>
                           </td>
                           <td class="wd-sm">
                              <div class="px-2">
