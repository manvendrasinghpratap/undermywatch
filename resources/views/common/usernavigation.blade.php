         ...
         <div class="aside-inner">
            <nav class="sidebar" data-sidebar-anyclick-close="">
               ...
               <ul class="sidebar-nav">
                  ...
                  <li  class="@if(Route::current()->getName() == 'user.home')) active @endif " >
                    <a href="{{ route('user.home') }}"  title="Dashboard"><em class="far fa fa-rainbow"></em><span>Dashboard</span></a></li>

                  <li class="@if(((Request::segment('2')=='sections') && (Request::segment('1')=='user') ) ||(Request::segment('2')=='campaigns') || ((Request::segment('1')=='admin') && (Request::segment('2')=='section'))) active @endif">
                    <a href="{{ route('user.sections.index') }}" title="Campaigns"><em class="far fa fa-mask"></em><span>Campaigns</span></a>
                  </li>

                  <li class="@if((Request::segment('3')=='domains') || (Request::segment('3')=='domain')) active @endif">
                    <a href="{{ route('user.domains.index') }}" title="Domains"><em class="far fa fa-list-ul"></em><span>Domains</span></a>
                  </li>
                  <li class="@if(((Request::segment('3')=='stats') && (Request::segment('2')=='admin')) || (Request::segment('3')=='companystats') && (Request::segment('2')=='admin'))) active @endif">
                    <a href="{{route('user.stats.userstats')}}" title="Reports"><em class="far fa fa-chart-line"></em><span>Reports</span></a>
                  </li>
               </ul><!-- END sidebar nav-->
            </nav>
