                       ...
                       <form action="{{ route('superadmin.sections.create') }}" method="POST" enctype="multipart/form-data">
                        {{ csrf_field() }}
                           <div class="form-group"><label>Shield Name</label>
                             <input class="form-control" type="text" name="name" value="{{ old('name') }}" placeholder="Enter Shield Name" required>

                           </div>
                           <div class="form-group"><label>Slug</label><input class="form-control" name="slug" value="{{ old('slug') }}" type="text" placeholder="Enter slug for your Shield">
                        ...
                        @endif
                           ...
                           <div class="form-group"><label>Notes</label><input class="form-control" type="text" name="notes" placeholder="Enter any notes" value="{{ old('notes') }}"></div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="hidden" name="setting[33][field]" value="timezone_check">
                                            <input type="text" class="form-control" name="setting[33][field_title]" placeholder="Title"   value="@if(!empty(old('setting')) && !empty(old('setting')[33]) && !empty(old('setting')[33]['field_title']) && old('setting')[33]["field_title"]){{ old('setting')[33]["field_title"] }} @else Enable Timezone Check (Double Meta by default) @endif">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="hidden" name="setting[38][field]" value="loglink">
                                            <input type="text" class="form-control" name="setting[38][field_title]" placeholder="Title"   value="@if(!empty(old('setting')) && !empty(old('setting')[38]) && !empty(old('setting')[38]['field_title']) && old('setting')[38]["field_title"]){{ old('setting')[38]["field_title"] }}@else Enable Logs @endif">
                                <div class="input-group-append">
                                    <span class="input-group-text">
                                        <div class="checkbox c-checkbox shield">
                                            <label>
                        ...
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                ...
                                <input type="text" class="form-control" name="setting[41][field_title]" placeholder="Title"   value="@if(!empty(old('setting')) && !empty(old('setting')[41]) && !empty(old('setting')[41]['field_title']) && old('setting')[41]["field_title"]){{ old('setting')[41]["field_title"] }} @else Extra Notes @endif">
                                <div class="input-group-append">
                                    <span class="input-group-text">
                                        <div class="checkbox c-checkbox shield">
                                            <label>
