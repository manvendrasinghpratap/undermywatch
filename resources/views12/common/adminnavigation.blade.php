            ...
            <nav class="sidebar" data-sidebar-anyclick-close="">
              {{Request::segment('2')}}
               ...
               <ul class="sidebar-nav">
                  ...
                  <li><a href="{{ route('admin.home') }}"  title="Dashboard"><em class="far fa fa-rainbow"></em><span>Dashboard</span></a></li>
                  <li class="@if(((Request::segment('3')=='sections') && (Request::segment('2')=='admin') ) ||(Request::segment('3')=='campaigns') || ((Request::segment('2')=='admin') && (Request::segment('3')=='section'))) active @endif">
                    <a href="{{ route('admin.sections.index') }}" title="Campaigns"><em class="far fa fa-mask"></em><span>Campaigns</span></a>
                  </li>
                  <li class="@if((Request::segment('3')=='domains') || (Request::segment('3')=='domain')) active @endif">
                    <a href="{{ route('admin.domains.index') }}" title="Domains"><em class="far fa fa-list-ul"></em><span>Domains</span></a>
                  </li>
                  <li class=" @if(((Request::segment('3')=='users') && (Request::segment('2')=='admin') ) || ((Request::segment('3')=='usersetting') && (Request::segment('2')=='admin')) || ((Request::segment('3')=='userstatsUserId') && (Request::segment('2')=='admin')) ) active @endif"><a href="{{ route('admin.users.index') }}" title="Campaigns"><em class="far fa fa-users"></em><span>Users</span></a></li>
                  <li class="@if(((Request::segment('3')=='company') && (Request::segment('4')=='assignedsection'))) active @endif">
                    <a href="{{route('admin.company.assignedsection')}}" title="Ghost Shields"><em class="far fa fa-ghost"></em><span>Ghost Shields </span></a>
                  </li>
                  <li class="@if(((Request::segment('3')=='stats') && (Request::segment('2')=='admin')) || (Request::segment('3')=='companystats') && (Request::segment('2')=='admin'))) active @endif">
