	            ...
	            <div class="row">
	               ...
	               <div class="card-body">
	                     ...
	                     <div class="form-row align-items-center">
	                        ...
	                        <div class="col-lg-3">
	                           <select class="form-control" id="select2-4">
	                                 <option></option>
	                         ...
	                         <div class="col-lg-3"><label class="sr-only" for="inlineFormInput">Any Notes</label><input class="form-control" id="inlineFormInput" type="text" placeholder="Enter Notes" style="height: 2.375rem;"></div>
	                        <div class="col-lg-3">
