                    ...
                    <div class="card card-default">
                       ...
                       <div class="card-body">
                        ...
                        <div class="form-group"><label>Countries</label>
                                  ...
                                  <option selected = "selected" value="DZ" label="Algeria">Algeria</option>
                                  ...
                                  <option selected = "selected" value="CV" label="Cape Verde">Cape Verde</option>
                          ...
                          <div class="form-group row">
                             ...
                             @if(!empty($link->section->settings) && !empty($link->section->settings->where('field', 'click_limit')->first()))
                                 <div class="input-group" style="margin-bottom:15px; @if($link->section->settings->where('field', 'click_limit')->first()->is_hidden) display: none; @endif">
                                   ...
                                   <input type="text" aria-label="Amount (to the nearest dollar)" placeholder="Amount (to the nearest dollar)" class="form-control" name="click_limit" value="{{ $link->click_limit ?? $link->section->settings->where('field', 'click_limit')->first()->default }}"> 
                             ...
                             @if(!empty($link->section->settings) && !empty($link->section->settings->where('field', 'extra_notes')->first()))
                                 <div class="input-group" style="margin-bottom:15px; @if($link->section->settings->where('field', 'extra_notes')->first()->is_hidden) display: none; @endif">
                                   ...
                                   <input type="text" aria-label="Amount (to the nearest dollar)" placeholder="Amount (to the nearest dollar)" class="form-control" name="extra_notes" value="{{ $link->notes ?? $link->section->settings->where('field', 'extra_notes')->first()->default }}">
