        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-sm-12">
                        <div class="row">
                            <form method="POST" action="{{ route('admin.links.createlink', ['section' => $section->slug]) }}" class="AjaxForm_">
                                {{ csrf_field() }}
                        ...
                        <div class="pull-right">
                            @if(!Request::get("all", false) ?? false)<a href="{{ route('admin.sections.section', ['section' => $section->slug, 'all' => 1]) }}" class="btn btn-primary">Show All</a> @else <a href="{{ route('admin.sections.section', ['section' => $section->slug ]) }}" class="btn btn-primary">Show Mine</a> @endif
                        </div>
                        <br>
                        <br>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(Auth::user()->id == $link->createdby->id)
                                            <a href="{{ route('admin.links.linkscrape', ['link' => $link->id]) }}" class="btn btn-xs btn-primary"><i class="fa fa-cloud-download-alt"></i></a>
                                            <form action="{{ route('admin.links.linkdelete', ['link' => $link->id]) }}" method="POST" style="display:inline-block;">
                                                {{ csrf_field() }}
                                                <button type="submit" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></button>
                                            </form>
                                        @endif
                                        <a href="{{ route('admin.logs.link', ['link'=> $link->id]) }}" class="btn btn-xs btn-primary"><i class="fa fa-eye"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
